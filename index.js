...
const questions = [
    ...
    {
        type: "input",
        message: "Provide instructions and examples for application use.",
        name: "instructions"
    },
    {
        type: "input",
        message: "Include a screenshot as needed, in file path format, ex: ./assets/images/image.png",
        name: "screenshot"
    },
    {
        type: "input",
    ...
    {
        type: "input",
        message: "List any third-party sources.",
        name: "thirdparty"
    },
    {
        type: "input",
